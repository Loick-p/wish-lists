...
@section('content')
    <h1 class="font-extrabold text-4xl mb-8">Réinitialisation du mot de passe</h1>

    <form method="POST" action="{{ route('password.store') }}" id="reset-password-form" class="mb-4">
        @csrf
        ...
        <button type="submit" id="reset-password-button" class="w-full text-white bg-red-500 hover:bg-red-600 font-medium rounded-lg text-sm px-5 py-2.5 my-2">
    ...
    <script>
        ...
        resetPasswordForm.addEventListener('submit', function(e) {
            ...
            // Bouton anti spam
            activateButtonIndicator(resetPasswordButton)
